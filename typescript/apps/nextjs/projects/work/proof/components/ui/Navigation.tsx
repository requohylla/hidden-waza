      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center min-w-0 flex-shrink">
            ...
            <h1 className="ml-2 text-xl font-semibold text-gray-900 truncate">職務経歴書システム</h1>
          </div>

          {/* Navigation Links - PC版では非表示 */}
          <div className="hidden md:flex items-center space-x-4">
            {/* PC版ではナビゲーションボタンを表示しない */}
          </div>
          ...
          <div className="flex items-center space-x-2 flex-shrink-0">
            ...
            <button
              ...
              className="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100 transition-colors whitespace-nowrap"
            >
